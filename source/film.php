...
// Assuming you set this session variable upon successful login
        ...
        <div class="flex flex-wrap justify-between items-center mx-auto max-w-screen-xl p-4">
            ...
            <div class="flex items-center space-x-6 rtl:space-x-reverse">
                ...
                <form action="./include/logout.php" method="POST">
                    <button type="submit"
                        class="border text-white bg-red-700 hover:bg-red-800 focus:ring-4 focus:ring-red-300 font-medium rounded-lg text-sm px-5 py-2.5 dark:bg-red-600 dark:hover:bg-red-700 focus:outline-none dark:focus:ring-red-800">
                        Logout
                    </button>
                </form>
                <?php else: ?>
                <!-- Login button when the user is not logged in -->
                <a href="./include/test_connection.php"
                    class="border text-white bg-blue-700 hover:bg-blue-800 focus:ring-4 focus:ring-blue-300 font-medium rounded-lg text-sm px-5 py-2.5 dark:bg-blue-600 dark:hover:bg-blue-700 focus:outline-none dark:focus:ring-blue-800">Login</a>
                <?php endif; ?>
            </div>
        </div>
    </nav>
    ...
    <div class="flex w-full">
        ...
        <div class="w-4/5 p-4 border-l border-r">
            ...
            <div id="pagination-controls" class="flex justify-center mt-4 hidden">
                <button id="prev-btn" class="mr-2 bg-blue-500 text-white px-4 py-2 rounded"
                    onclick="changePage(-1)">Previous</button>
                <button id="next-btn" class="bg-blue-500 text-white px-4 py-2 rounded"
    ...
    <footer class="bg-white shadow dark:bg-gray-900">
        <div class="w-full text-center max-w-screen-xl mx-auto p-4 md:py-8">
            <div class="flex flex-col items-center">
                <ul
                    class="flex flex-wrap justify-center mb-6 text-sm font-medium text-gray-500 sm:mb-0 dark:text-gray-400">
    ...
    function displayMovies() {
        ...
        paginatedMovies.forEach(movie => {
            ...
            overlayDiv.className =
                'absolute inset-0 bg-gray-800 bg-opacity-75 flex items-center justify-center opacity-0 overlay transition-opacity duration-300';
