...
<body>
  ...
  <div class="flex flex-col h-screen justify-between">
    <header>
      <nav class="color-class border-gray-200 fixed w-full top-0 left-0 z-50 bg-white dark:bg-gray-900">
    ...
    <main class="mb-auto">
      <div class="flex flex-wrap w-full pb-0 mb-0">
        <div class="sidebar p-2 w-full md:w-1/4 lg:w-1/5">
          <form class="flex items-center max-w-sm mx-auto mb-4" method="POST" action="./include/filter_db.php">
    ...
    <footer class="bg-white shadow dark:bg-gray-900">
      <div class="w-full max-w-screen-xl mx-auto p-4 md:py-8 flex flex-col sm:flex-row justify-between items-center">
