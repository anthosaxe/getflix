      ...
      <nav class="color-class border-gray-200 fixed w-full top-0 left-0 z-50 bg-gray-900">
        ...
        <main class="mb-auto h-10">
            <form class="max-w-sm mx-auto my-5" action="./include/register_process.php" method="post">
                <div class="mb-5">
                    <label for="username" class="block mb-1 text-sm font-medium text-white">Your username</label>
                ...
                <div class="mb-5">
                    <label for="password" class="block mb-1 text-sm font-medium text-white">Your password</label>
                ...
                <div class="mb-5">
                    <label for="repeat-password" class="block mb-1 text-sm font-medium text-white">Repeat password</label>
                ...
                <div class="flex items-start mb-5">
                    ...
                    <label for="terms" class="ms-2 text-sm font-medium text-gray-300">subscribe to newsletter</a></label>
                </div>
                <button type="submit" class="mb-5 text-white bg-blue-700 hover:bg-blue-800 focus:ring-4 focus:outline-none focus:ring-blue-300 font-medium rounded-lg text-sm px-5 py-2.5 text-center dark:bg-blue-600 dark:hover:bg-blue-700 dark:focus:ring-blue-800">Register new account</button>
                <p class="text-white">Already have an account? Login <a href="login.php" class="mb-4 font-medium text-blue-600 dark:text-blue-500 hover:underline">here</a></p>
            </form>
        </main>
