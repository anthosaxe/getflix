...
<body class="body-color">
    ...
    <div class="main-box">
        ...
        <div class="sidebar_menu">
            ...
            <div class="menu">
                <ul>
                    <li><a href="genres.php"><i class="fa-solid fa-eye"></i> Genres</a></li>
                    <li><a href="series.php"><i class="fa-solid fa-clapperboard"></i> Séries</a></li>
                    <li><a href="films.php"><i class="fa-solid fa-film"></i> Films</a></li>
                    <li><a href="maListe.php"><i class="fa-solid fa-face-kiss-wink-heart"></i> Ma liste</a></li>
                </ul>
            </div>
        </div>
    </div>
